        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">资金交易-提现确认</div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="checkForm" name="checkForm" novalidate="novalidate">
                	<div class="form-body">
                		<input type="hidden" class="form-control" id="txType" name="txType" value="cashConfirm">
                		...
                		<input type="hidden" class="form-control" id="checkFilePath" name="checkFilePath">
                    </div>
					<div class="form-actions">
