...
<head>
    ...
    <script src="${ctx}/assets/users/js/roleList.js" type="text/javascript"></script>
</head>
<!-- END HEAD -->
                ...
                <div class="portlet-body">
                    <div id="sample_2_wrapper" class="dataTables_wrapper no-footer">
                    	<div id="roleTb">
                       	...
                       	<table id="roleDg" class="table table-striped table-bordered table-hover" style="white-space :nowrap"></table>
                    </div>
                </div>
            </div>
        </div>
