...
<head>
    ...
    <script src="${ctx}/assets/users/js/factorAdd.js" type="text/javascript"></script>
</head>
<!-- END HEAD -->
        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">保理合同-录入</div>
                </div>
                <div class="portlet-body">
	                <form class="form-horizontal" id="factorAddForm" name="factorAddForm" >
	                    <div class="form-body">
	                        <br>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-md-3">
	                                ...
	                                <input type="hidden" class="form-control" id="custSellName" name="custSellName">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> 保理商</label>
	                            <div class="col-md-3">
	                            	<input type="hidden" class="form-control" id="custfactor" name="custfactor" >
	                                <input type="text" class="form-control" id="custfactorName" name="custfactorName" readonly>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> 保理金额</label>
	                            <div class="col-md-3">
	                                <input type="text" class="form-control" id="factorAmt" name="factorAmt" >
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> 还款方式</label>
	                            <div class="col-md-3">
	                                <input type="text" class="form-control" id="payment" name="payment" value="到期还本付息" readonly>
	                            </div>
	                        </div>
	                        <div class="form-group">
