        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">资金交易-贷款偿还</div>
                </div>
	                ...
	                <form class="form-horizontal" id="userAmdForm" name="userAmdForm" >
	                    <div class="form-body">
	                        ...
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> 贷款合同编号 </label>
	                            <div class="col-md-3">
	                                <input type="text" class="form-control" id="loginName" name="loginName" value="XXXXX" readonly>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> 债务人</label>
	                            <div class="col-md-3">
	                                <input type="text" class="form-control" id="userName" name="userName" value="保理商1" readonly>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> 债权人</label>
	                            <div class="col-md-3">
	                                <input type="text" class="form-control" id="userName" name="userName" value="XX银行" readonly>
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="control-label col-md-3"> 贷款金额</label>
	                            <div class="col-md-3">
	                        ...
	                        <div class="form-group">
                                <label class="control-label col-md-3">贷款合同附件</label>
                                <div class="col-md-3">
                                    <a href="#" class="btn green"> XXX贷款合同.doc </a>
                                </div>
                            </div>
	                        <div class="form-group">
            ...
            <div class="modal-body">
                <form id="ChangePasswordModalForm" name="ChangePasswordModalForm" novalidate="novalidate">
                    ...
                    <div class="modal-footer">
                    	...
                    	<button type="button" class="btn btn-danger" data-dismiss="modal">否决</button>
