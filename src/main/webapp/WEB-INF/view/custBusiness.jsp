...
<head>
    ...
    <script src="${ctx}/assets/users/js/custBusiness.js" type="text/javascript"></script>
</head>
<!-- END HEAD -->
        ...
        <div class="page-content">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">交易复核</div>
                </div>
                <div class="portlet-body">
                    <div id="sample_2_wrapper" class="dataTables_wrapper no-footer">
                    	<div id="custBusinessTb">
	                        <div class="row">
	                            <div class="col-md-3">
                       	...
                       	<table id="custBusinessDg" class="table table-striped table-bordered table-hover "></table>
                    </div>
                </div>
            </div>
        </div>
