...
<head>
    ...
    <script src="${ctx}/assets/users/js/rateList.js" type="text/javascript"></script>
</head>
<!-- END HEAD -->
                    ...
                    <div id="sample_2_wrapper" class="dataTables_wrapper no-footer">
                    	<div id="rateTb">
	                        <div class="row">
	                            ...
	                            <div class="col-md-3">
	                                <label class="control-label">收取机构</label>
	                                <select class="form-control" id="toCustId">
	                            ...
	                            <div class="col-md-3">
	                                ...
	                                <select class="form-control" id="status">
	                                	<option value="">请选择...</option>
	                                	<option value="1">当前费率</option>
	                                	<option value="2">历史费率</option>
	                                </select>
	                            </div>
	                        </div>
                       	...
                       	<table id="rateDg" class="table table-striped table-bordered table-hover " style="white-space :nowrap"></table>
                    </div>
                </div>
            </div>
        </div>
